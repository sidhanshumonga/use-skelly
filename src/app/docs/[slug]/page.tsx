      ...
      <div style={{ fontSize: "15.5px", color: "#3A3833", lineHeight: 1.65 }}>
        ...
        {slug === "framework-adapters" && (
          <div style={{ display: "flex", flexDirection: "column", gap: "24px" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
              <h3 style={{ fontSize: "18px", fontWeight: 600, margin: "0 0 4px", color: "#1C1C1A" }}>React Adapter (skellyjs/react)</h3>
              <p style={{ margin: 0 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "12px", borderTop: "1px solid rgba(28,28,26,.08)", paddingTop: "24px" }}>
              <h3 style={{ fontSize: "18px", fontWeight: 600, margin: "0 0 4px", color: "#1C1C1A" }}>Vue Adapter (skellyjs/vue)</h3>
              <p style={{ margin: 0 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "12px", borderTop: "1px solid rgba(28,28,26,.08)", paddingTop: "24px" }}>
              <h3 style={{ fontSize: "18px", fontWeight: 600, margin: "0 0 4px", color: "#1C1C1A" }}>Svelte Adapter (skellyjs/svelte)</h3>
              <p style={{ margin: 0 }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "12px", borderTop: "1px solid rgba(28,28,26,.08)", paddingTop: "24px" }}>
              <h3 style={{ fontSize: "18px", fontWeight: 600, margin: "0 0 4px", color: "#1C1C1A" }}>Vanilla JavaScript Core (skellyjs)</h3>
              <p style={{ margin: 0 }}>
